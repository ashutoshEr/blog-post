...
@section('bg-img',asset('user/img/solo.jpg'))

@section('title', 'Welcome To My Blog Site')

@section('subheading','New age blog site')
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="user/img/service-item-01.png" alt="">
                                    <h4>Top Notch</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="service-item">
                                    <img src="user/img/contact-info-03.png" alt="">
                                    <h4>Reliable</h4>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p><a rel="nofollow noopener" href="https://templatemo.com/tm-543-breezed" target="_parent">My Blog Site</a> is provided by Us for absolutely free of charge. You can register with us to use this for your non-commercial and commercial blog site. 
                        <br><br>You will need to talk to us if you want to redistribute this Blog site. Thank you.
                      <br><br>Do you like it? You can feel free to <a rel="nofollow noopener" href="https://templatemo.com/contact" target="_parent">talk to us</a> if you have anything.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        <div class="features-icon">
                            <img src="user/img/features-icon-1.png" alt="">
                        </div>
    ...
    <section class="section" id="">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12">
          <iframe style="width:100%; height:450px;" src="https://inshorts.com/en/read" frameborder="0"></iframe>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <ul class="contact-info">
                            <li><img src="user/img/contact-info-01.png" alt="">8757682502</li>
                            <li><img src="user/img/contact-info-02.png" alt="">info@myblogsite.weentry.com</li>
                            <li><img src="user/img/contact-info-03.png" alt="">www.myblogsite.weentry.com</li>
                        </ul>
                    </div>
                </div>
...
#contact-us {
  padding: 120px 0px;
  background-image: url(user/img/dotted-map-bg.png);
  background-position: center center;
  background-repeat: no-repeat;
}
