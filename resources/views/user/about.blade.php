    ...
    <div class="container">
      ...
      <div class="row heading">
        <div class="col-md-12 ">
          ...
          <p class="subheading text-center">People who have helped us in the journey</p>
        </div>
      </div>
      ...
      <div class="row team-row">
        ...
        <div class="col-md-4 col-sm-6 team-wrap">
          <div class="team-member text-center">
            ...
            <h6 class="team-title">Amit kumar dubey</h6>
            <span>Developer</span>
          </div>
        </div>
        <!-- end team member -->
        ...
        <div class="col-md-4 col-sm-6 team-wrap">
          <div class="team-member text-center">
            ...
            <h6 class="team-title">Ashutosh sharma</h6>
            <span>Developer</span>
          </div>
        </div>
        <!-- end team member -->
        ...
        <div class="col-md-4 col-sm-6 team-wrap">
          <div class="team-member last text-center">
            ...
            <h6 class="team-title">Akash garg</h6>
            <span>Developer</span>
          </div>
        </div>
        <!-- end team member -->
